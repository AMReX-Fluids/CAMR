...
void make_eb_box(const Geometry& geom, int required_coarsening_level)
{
...

    {
        ...
        {
            boxLo[i] = geom.ProbLo(i);
            boxHi[i] = geom.ProbHi(i);
        }
        ...
        {
            xlo = 2.0 * geom.ProbLo(0) - geom.ProbHi(0);
            xhi = 2.0 * geom.ProbHi(0) - geom.ProbLo(0);
        }
        ...
        {
            ylo = 2.0 * geom.ProbLo(1) - geom.ProbHi(1);
            yhi = 2.0 * geom.ProbHi(1) - geom.ProbLo(1);
        }
        ...
        {
            zlo = 2.0 * geom.ProbLo(2) - geom.ProbHi(2);
            zhi = 2.0 * geom.ProbHi(2) - geom.ProbLo(2);
        }
